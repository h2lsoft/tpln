...
define('TPLN_VERSION', '4.0'); // TPLN version do not touch please!

/***************************** Configuration ***************************************************/
define('TPLN_LANG','en'); // default Error language 'en' , 'fr'

define('TPLN_WEB_PATH', 'http://localhost/php/TPLN') ; // your website TPLN url NO slash at end ! (absolute path)
...
define('TPLN_MAIL_ADMIN', 'webmaster@website.com'); // email adress for error alert (for the webmaster)
define('TPLN_MAIL_EXPEDITOR', 'tpln@website.com'); // the expeditor email by default
...
define('TPLN_DB_LOGIN_DEFAULT', "root"); // your login by defaut
define('TPLN_DB_PASSWORD_DEFAULT', ""); // your password by defaut
define('TPLN_DB_BASE_DEFAULT', "my_database"); // your base by defaut
